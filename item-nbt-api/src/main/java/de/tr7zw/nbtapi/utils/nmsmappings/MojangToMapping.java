...
public class MojangToMapping {
	...
	private static final Map<String, String> MC1_21R1 = new HashMap<String, String>() {
		{
			putAll(MC1_20R4);
	...
	private static final Map<String, String> MC1_21R2 = new HashMap<String, String>() {
		{
			putAll(MC1_21R1);
	...
	private static final Map<String, String> MC1_21R3 = new HashMap<String, String>() {
		{
			putAll(MC1_21R2);
	...
	private static final Map<String, String> MC1_21R4 = new HashMap<String, String>() {
	...
	private static final Map<String, String> MC1_21R5 = new HashMap<String, String>() {
		{
			putAll(MC1_21R3);
	...
	public static Map<String, String> getMapping() {
		switch (MinecraftVersion.getVersion()) {
			...
			case MC1_18_R1:
				return MC1_18R1;
			case UNKNOWN:
				return MC1_21R5; // assume it's a future version, so try the latest known mappings
			default:
